...
- **Автоматический RCA:** Моментальный анализ инцидентов на основе метрик и логов.
- **Интерактивные уточнения:** Возможность задавать боту дополнительные вопросы прямо в чате (через Reply), чтобы углубиться в детали.
- **Безопасный доступ:** Бот читает данные только из вашего приватного контура.
- **Мультиязычность:** Бот может отвечать на русском или английском языках в зависимости от настроек.
...
| Раздел                                            | Описание                              |
| ------------------------------------------------- | ------------------------------------- |
| [Быстрый старт](/guide/setup)                     | Установка через Helm в Kubernetes     |
| [Веб-дашборд](/guide/dashboard)                   | Управление ботами, инциденты, биллинг |
| [Управление организациями](/guide/organizations)  | Multi-org, создание и переключение    |
| [Управление командой](/guide/team-management)     | Роли, приглашения, передача владения  |
| [Общение с ботом](/guide/interaction)             | Follow-up вопросы, mute/unmute        |
